export const ro = {
  ...
  dashboard: {
    ...
    summaryStats: {
      ...
      uniqueParticipants: 'Participanți',
      completedBoth: 'Ambele Complete',
      incomplete: 'Incomplete',
      completed: 'Finalizate',
      copyCompleted: 'Copiază emailuri complete ({{count}})',
      copyIncomplete: 'Copiază emailuri incomplete ({{count}})',
      pairedNote: 'Graficele și statisticile se bazează pe {{count}} participanți care au completat ambele sesiuni (comparație intra-subiecți).',
      pairedDelta: 'Delta Perechi',
      pairedNasaDelta: 'Comparație Perechi (Adaptiv - Control)',
